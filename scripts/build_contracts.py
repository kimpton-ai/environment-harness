...
try:
    from environment_harness import motor_contracts
except ImportError:  # Optional motor support remains absent on older installs.
    motor_contracts = None
...
if motor_contracts is not None:
    for name in (
        "MotorProfile",
        "MotorRequest",
        "MotorStep",
