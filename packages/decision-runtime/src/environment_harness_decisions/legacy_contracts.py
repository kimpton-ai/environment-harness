"""Version 1 motor record reader retained for explicit saved-run migration.

New invocations use the decision.v1 contracts. These records do not authorize
new effects and core EnvironmentHarness does not import them.
"""
