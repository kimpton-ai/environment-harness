...
from test_runtime import Browser, execute
from test_runtime import setup as make_setup
...
def test_prepared_successor_requires_live_predecessor(tmp_path):
    ...
    successor = PreparedSuccessor(
        ...
        predecessor_execution_id="session:op-1:execution:0",
        execution_id="session:op-1:execution:1",
