...
Install the `environment-harness-client-0.2.3-rc.1.tgz` asset from the GitHub release with `npm install ./environment-harness-client-0.2.3-rc.1.tgz`. A registry publication is not required.
