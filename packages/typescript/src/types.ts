...
export interface MotorExecutionMetadata {contract_version:'motor.execution.v1'; owner:string; owner_id?:string; epoch:number; goal_revision:string; observation_revision:string; stop_epoch:number; interface_revision?:string|null; ui_revision?:string|null; observation_frame_id?:string|null; camera_revision?:string|null;}
