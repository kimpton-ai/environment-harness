...
export interface MotorRequest {skill:string; target:Record<string,Json>; arguments?:Record<string,Json>; expected:Record<string,Json>; observation_revision:string; goal_revision:string; stop_epoch?:number; max_steps?:number; timeout_ms?:number; control_permissions?:MotorControlPermission[]; max_recovery_attempts?:number;}
