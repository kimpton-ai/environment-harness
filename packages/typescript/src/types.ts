...
export interface MotorExecutor {execute(operation_id:string, request:Record<string,Json>, maximum_cost_micros:number):MotorReceipt; stop():void; lookup(operation_id:string):MotorReceipt|null;}
