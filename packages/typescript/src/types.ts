...
export interface MotorExecutionMetadata {contract_version:'motor.execution.v1'; owner:string; epoch:number; goal_revision:string; observation_revision:string; stop_epoch:number; interface_revision?:string|null; ui_revision?:string|null;}
export interface PreparedSuccessorIntent {contract_version:'motor.prepared-successor.v1'; intent_id:string; operation_id:string; predecessor_operation_id:string; metadata:MotorExecutionMetadata; step:MotorStep; prepared_at_ms:number; freshness_ms:number; phase:'prepared';}
